...
from screens.forms import confirmation_for_structure, Freedom_Info, CollectiveLifeInsurance
...
class ScreensFactory(object):
    ...
    def create_screen(self, objects_list=None, store_screen=True, force_create=False, driver=None):
        ...
        screens_dict = {
            ...
            'CollectiveLifeInsurance' : CollectiveLifeInsurance.CollectiveLifeInsurance,
        }
