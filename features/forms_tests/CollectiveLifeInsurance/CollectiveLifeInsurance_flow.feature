Feature: Test for CollectiveLifeInsurance Form Page
...
#    When check the header application name is "טופס הצטרפות לביטוח חיים קולקטיבי לעובדי העירייה"
#    When check the header status text
#    When check the header status date
#    When I check that the buttons count is  "3"
#    When check the date
#    When check the explanation area
#    When check the explanation tittle
#    When check the explanation body
#    When check the status is "חדש"
    Then I click on header "שמור" button
